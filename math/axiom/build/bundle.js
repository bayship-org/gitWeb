...
var app = (function () {
    ...
    /* src\components\Home.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "HOME";
    			add_location(h1, file, 2, 0, 27);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 1, 0, 2);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "This is a news app created with Svelte";
    			attr_dev(div, "class", "container");
    			add_location(div, file$1, 3, 0, 24);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\NotFound.md generated by Svelte v3.25.1 */

    const file$2 = "src\\components\\NotFound.md";
    ...
    */
    ...
    /* src\components\Katex.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			html_tag.m(/*latexHtml*/ ctx[0], target, anchor);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Katex", slots, []);
    	let { latex } = $$props, { displayMode = false } = $$props;
    	let latexHtml = katex.renderToString(latex, { displayMode, throwOnError: false });
    	const writable_props = ["latex", "displayMode"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Katex> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ katex, latex, displayMode, latexHtml });

    	$$self.$inject_state = $$props => {
    		if ("latex" in $$props) $$invalidate(1, latex = $$props.latex);
    		if ("displayMode" in $$props) $$invalidate(2, displayMode = $$props.displayMode);
    		if ("latexHtml" in $$props) $$invalidate(0, latexHtml = $$props.latexHtml);
    	};
    	...
    	return [latexHtml, latex, displayMode];
    }

    class Katex extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { latex: 1, displayMode: 2 });
    		...
    		if (/*latex*/ ctx[1] === undefined && !("latex" in props)) {
    			console.warn("<Katex> was created without expected prop 'latex'");
    		}
    	}
    ...
    /* src\components\Box.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "box svelte-x7fvc4");
    			set_style(div, "background", /*bgc*/ ctx[0]);
    			add_location(div, file$3, 15, 0, 252);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("bgc" in $$props) $$invalidate(0, bgc = $$props.bgc);
    		if ("$$scope" in $$props) $$invalidate(1, $$scope = $$props.$$scope);
    	};

    	$$self.$capture_state = () => ({ bgc });
    	...
    	return [bgc, $$scope, slots];
    }

    class Box extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { bgc: 0 });
    ...
    /* src\components\Badge.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			t6 = text(/*num*/ ctx[1]);
    			attr_dev(div, "class", "pagebreak");
    			add_location(div, file$4, 17, 0, 300);
    			attr_dev(path0, "d", "M 0 0 v 10 h 10 v -10 Z ");
    			add_location(path0, file$4, 20, 1, 475);
    			attr_dev(g0, "fill", "#034");
    			add_location(g0, file$4, 19, 0, 455);
    			attr_dev(path1, "d", "M 10 10  h 1 v -1 h -1 Z ");
    			add_location(path1, file$4, 23, 2, 544);
    			attr_dev(g1, "fill", "#034");
    			add_location(g1, file$4, 22, 1, 523);
    			attr_dev(path2, "d", "M 3 0 L 5 2.5 L 7 0 Z  ");
    			add_location(path2, file$4, 26, 1, 614);
    			attr_dev(path3, "d", "M 3 10 v -2.5 h 4 v 2.5 Z ");
    			add_location(path3, file$4, 27, 1, 655);
    			attr_dev(g2, "fill", "white");
    			add_location(g2, file$4, 25, 1, 593);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 12 10");
    			attr_dev(svg, "stroke", "none");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "width", svg_width_value = "" + (u * 1.2 + "em"));
    			attr_dev(svg, "height", svg_height_value = "" + (u + "em"));
    			attr_dev(svg, "class", "svelte-j8fyh5");
    			add_location(svg, file$4, 18, 0, 331);
    			attr_dev(span, "class", "bg-transparent text-blue-700 font-semibold  py-2 px-4   rounded svelte-j8fyh5");
    			add_location(span, file$4, 30, 0, 714);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*type*/ 1) set_data_dev(t4, /*type*/ ctx[0]);
    			if (dirty & /*num*/ 2) set_data_dev(t6, /*num*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    class Badge extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { type: 0, num: 1 });
    ...
    /* src\components\Svlt.svelte generated by Svelte v3.25.1 */

    const file$5 = "src\\components\\Svlt.svelte";
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Svlt", slots, ['default']);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Svlt> was created with unknown prop '${key}'`);
    	});
    ...
    class Svlt extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\md\dist.tmp\axiom.md generated by Svelte v3.25.1 */
    const file$6 = "src\\md\\dist.tmp\\axiom.md";
    ...
    function create_default_slot_15(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Axiom of Definition length";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "2020/09/23";
    			t3 = space();
    			p1 = element("p");
    			p1.textContent = "Shigeo Hattori";
    			add_location(h3, file$6, 1, 60, 66);
    			add_location(p0, file$6, 2, 0, 102);
    			add_location(p1, file$6, 3, 0, 120);
    			attr_dev(div, "class", "markdown-body");
    			add_location(div, file$6, 1, 33, 39);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    function create_default_slot_14(ctx) {
    	...
    	katex1 = new Katex({ props: { latex: "X" }, $$inline: true });
    	katex2 = new Katex({ props: { latex: "M" }, $$inline: true });
    	katex3 = new Katex({ props: { latex: "K" }, $$inline: true });
    	katex4 = new Katex({ props: { latex: "K" }, $$inline: true });
    	katex5 = new Katex({ props: { latex: "S_K" }, $$inline: true });
    	katex6 = new Katex({ props: { latex: "K1" }, $$inline: true });
    	...
    	katex9 = new Katex({ props: { latex: "f" }, $$inline: true });
    	katex10 = new Katex({ props: { latex: "S_K" }, $$inline: true });
    	katex11 = new Katex({ props: { latex: "S_K" }, $$inline: true });
    	katex12 = new Katex({ props: { latex: "r" }, $$inline: true });
    	...
    	katex15 = new Katex({ props: { latex: "X" }, $$inline: true });

    	katex16 = new Katex({
    			props: {
    				latex: "\\{K1,K2\\}\\subset f^{-1}(\\{r\\})"
    			},
    			$$inline: true
    		});

    	katex17 = new Katex({ props: { latex: "F" }, $$inline: true });
    	katex18 = new Katex({ props: { latex: "X" }, $$inline: true });
    	katex19 = new Katex({ props: { latex: "F" }, $$inline: true });
    	katex20 = new Katex({ props: { latex: "K1" }, $$inline: true });
    	katex21 = new Katex({ props: { latex: "K2" }, $$inline: true });
    	katex22 = new Katex({ props: { latex: "F" }, $$inline: true });
    	katex23 = new Katex({ props: { latex: "K1" }, $$inline: true });
    	katex24 = new Katex({ props: { latex: "K3" }, $$inline: true });
    	katex25 = new Katex({ props: { latex: "K2" }, $$inline: true });

    	katex26 = new Katex({
    			props: { latex: "K3 \\in f^{-1}(\\{r\\})" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			ul3 = element("ul");
    			li0 = element("li");
    			t0 = text("For all Euclidean space ");
    			create_component(katex0.$$.fragment);
    			t1 = text(" where ");
    			create_component(katex1.$$.fragment);
    			t2 = text(" is the set of points and ");
    			create_component(katex2.$$.fragment);
    			t3 = text(" is the metric table:");
    			t4 = space();
    			li1 = element("li");
    			t5 = text("For all sub space ");
    			...
    			t10 = text(" of every such ");
    			create_component(katex6.$$.fragment);
    			t11 = text(" that ");
    			create_component(katex7.$$.fragment);
    			t12 = text(" is ");
    			span0 = element("span");
    			span0.textContent = "isomorphic";
    			t14 = text(" to ");
    			create_component(katex8.$$.fragment);
    			t15 = text(":");
    			t16 = space();
    			li3 = element("li");
    			t17 = text("For all function ");
    			create_component(katex9.$$.fragment);
    			t18 = text(" on ");
    			create_component(katex10.$$.fragment);
    			t19 = text(" which ");
    			span1 = element("span");
    			span1.textContent = "naturally";
    			t21 = text(" maps members of ");
    			create_component(katex11.$$.fragment);
    			t22 = text(" to real numbers:");
    			t23 = space();
    			li4 = element("li");
    			t24 = text("For all real number ");
    			create_component(katex12.$$.fragment);
    			t25 = text(", for the inverse image ");
    			create_component(katex13.$$.fragment);
    			t26 = text(":");
    			t27 = space();
    			li9 = element("li");
    			create_component(katex14.$$.fragment);
    			t28 = text(" is closed in terms of ambient isotopies on ");
    			create_component(katex15.$$.fragment);
    			t29 = text(".");
    			ul2 = element("ul");
    			li8 = element("li");
    			t30 = text("That is, for all ");
    			create_component(katex16.$$.fragment);
    			t31 = text(":");
    			ul1 = element("ul");
    			li7 = element("li");
    			t32 = text("For some ambient isotopy ");
    			create_component(katex17.$$.fragment);
    			t33 = text(" on ");
    			create_component(katex18.$$.fragment);
    			t34 = text(":");
    			ul0 = element("ul");
    			li5 = element("li");
    			create_component(katex19.$$.fragment);
    			t35 = text(" takes ");
    			create_component(katex20.$$.fragment);
    			t36 = text(" to ");
    			create_component(katex21.$$.fragment);
    			t37 = text(".");
    			t38 = space();
    			li6 = element("li");
    			create_component(katex22.$$.fragment);
    			t39 = text(" takes ");
    			create_component(katex23.$$.fragment);
    			t40 = text(" via ");
    			create_component(katex24.$$.fragment);
    			t41 = text(" to ");
    			create_component(katex25.$$.fragment);
    			t42 = text(" implies that ");
    			create_component(katex26.$$.fragment);
    			t43 = text(".");
    			add_location(li0, file$6, 12, 0, 497);
    			add_location(li1, file$6, 13, 0, 655);
    			set_style(span0, "color", "blue");
    			add_location(span0, file$6, 14, 115, 867);
    			add_location(li2, file$6, 14, 0, 752);
    			set_style(span1, "color", "red");
    			add_location(span1, file$6, 15, 78, 1027);
    			add_location(li3, file$6, 15, 0, 949);
    			add_location(li4, file$6, 16, 0, 1134);
    			add_location(li5, file$6, 20, 0, 1525);
    			add_location(li6, file$6, 21, 0, 1615);
    			add_location(ul0, file$6, 19, 78, 1520);
    			add_location(li7, file$6, 19, 0, 1442);
    			add_location(ul1, file$6, 18, 78, 1437);
    			add_location(li8, file$6, 18, 0, 1359);
    			add_location(ul2, file$6, 17, 107, 1354);
    			add_location(li9, file$6, 17, 0, 1247);
    			add_location(ul3, file$6, 11, 18, 492);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(li0, t1);
    			mount_component(katex1, li0, null);
    			append_dev(li0, t2);
    			mount_component(katex2, li0, null);
    			append_dev(li0, t3);
    			append_dev(ul3, t4);
    			append_dev(ul3, li1);
    			append_dev(li1, t5);
    			mount_component(katex3, li1, null);
    			append_dev(li1, t6);
    			mount_component(katex4, li1, null);
    			append_dev(li1, t7);
    			append_dev(ul3, t8);
    			append_dev(ul3, li2);
    			append_dev(li2, t9);
    			mount_component(katex5, li2, null);
    			append_dev(li2, t10);
    			mount_component(katex6, li2, null);
    			append_dev(li2, t11);
    			mount_component(katex7, li2, null);
    			append_dev(li2, t12);
    			append_dev(li2, span0);
    			append_dev(li2, t14);
    			mount_component(katex8, li2, null);
    			append_dev(li2, t15);
    			append_dev(ul3, t16);
    			append_dev(ul3, li3);
    			append_dev(li3, t17);
    			mount_component(katex9, li3, null);
    			append_dev(li3, t18);
    			mount_component(katex10, li3, null);
    			append_dev(li3, t19);
    			append_dev(li3, span1);
    			append_dev(li3, t21);
    			mount_component(katex11, li3, null);
    			append_dev(li3, t22);
    			append_dev(ul3, t23);
    			append_dev(ul3, li4);
    			append_dev(li4, t24);
    			mount_component(katex12, li4, null);
    			append_dev(li4, t25);
    			mount_component(katex13, li4, null);
    			append_dev(li4, t26);
    			append_dev(ul3, t27);
    			append_dev(ul3, li9);
    			mount_component(katex14, li9, null);
    			append_dev(li9, t28);
    			mount_component(katex15, li9, null);
    			append_dev(li9, t29);
    			append_dev(li9, ul2);
    			append_dev(ul2, li8);
    			append_dev(li8, t30);
    			mount_component(katex16, li8, null);
    			append_dev(li8, t31);
    			append_dev(li8, ul1);
    			append_dev(ul1, li7);
    			append_dev(li7, t32);
    			mount_component(katex17, li7, null);
    			append_dev(li7, t33);
    			mount_component(katex18, li7, null);
    			append_dev(li7, t34);
    			append_dev(li7, ul0);
    			append_dev(ul0, li5);
    			mount_component(katex19, li5, null);
    			append_dev(li5, t35);
    			mount_component(katex20, li5, null);
    			append_dev(li5, t36);
    			mount_component(katex21, li5, null);
    			append_dev(li5, t37);
    			append_dev(ul0, t38);
    			append_dev(ul0, li6);
    			mount_component(katex22, li6, null);
    			append_dev(li6, t39);
    			mount_component(katex23, li6, null);
    			append_dev(li6, t40);
    			mount_component(katex24, li6, null);
    			append_dev(li6, t41);
    			mount_component(katex25, li6, null);
    			append_dev(li6, t42);
    			mount_component(katex26, li6, null);
    			append_dev(li6, t43);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			...
    			transition_in(katex14.$$.fragment, local);
    			transition_in(katex15.$$.fragment, local);
    			transition_in(katex16.$$.fragment, local);
    			transition_in(katex17.$$.fragment, local);
    			transition_in(katex18.$$.fragment, local);
    			transition_in(katex19.$$.fragment, local);
    			transition_in(katex20.$$.fragment, local);
    			transition_in(katex21.$$.fragment, local);
    			transition_in(katex22.$$.fragment, local);
    			transition_in(katex23.$$.fragment, local);
    			transition_in(katex24.$$.fragment, local);
    			transition_in(katex25.$$.fragment, local);
    			transition_in(katex26.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			...
    			transition_out(katex14.$$.fragment, local);
    			transition_out(katex15.$$.fragment, local);
    			transition_out(katex16.$$.fragment, local);
    			transition_out(katex17.$$.fragment, local);
    			transition_out(katex18.$$.fragment, local);
    			transition_out(katex19.$$.fragment, local);
    			transition_out(katex20.$$.fragment, local);
    			transition_out(katex21.$$.fragment, local);
    			transition_out(katex22.$$.fragment, local);
    			transition_out(katex23.$$.fragment, local);
    			transition_out(katex24.$$.fragment, local);
    			transition_out(katex25.$$.fragment, local);
    			transition_out(katex26.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(katex14);
    			destroy_component(katex15);
    			destroy_component(katex16);
    			destroy_component(katex17);
    			destroy_component(katex18);
    			destroy_component(katex19);
    			destroy_component(katex20);
    			destroy_component(katex21);
    			destroy_component(katex22);
    			destroy_component(katex23);
    			destroy_component(katex24);
    			destroy_component(katex25);
    			destroy_component(katex26);
    		}
    	};
    ...
    function create_default_slot_13(ctx) {
    	...
    	let t3;
    	let current;
    	katex0 = new Katex({ props: { latex: "C" }, $$inline: true });
    	...
    	katex2 = new Katex({
    			props: { latex: "\\psi_{(S,f,y)}" },
    			$$inline: true
    		});

    	const block = {
    		c: function create() {
    			t0 = text("All component ");
    			create_component(katex0.$$.fragment);
    			t1 = text(" is specified in terms of ");
    			create_component(katex1.$$.fragment);
    			t2 = text(" by a shorter text than ");
    			create_component(katex2.$$.fragment);
    			t3 = text(" is specified by.");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t0, anchor);
    			mount_component(katex0, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(katex1, target, anchor);
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t0);
    			destroy_component(katex0, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(katex1, detaching);
    ...
    function create_default_slot_12(ctx) {
    	...
    	let t19;
    	let current;
    	katex0 = new Katex({ props: { latex: "S" }, $$inline: true });
    	katex1 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex2 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex3 = new Katex({ props: { latex: "p" }, $$inline: true });
    	...
    	katex6 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex7 = new Katex({ props: { latex: "y" }, $$inline: true });
    	katex8 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex9 = new Katex({ props: { latex: "y" }, $$inline: true });
    	katex10 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex11 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex12 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex13 = new Katex({ props: { latex: "x" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			li5 = element("li");
    			create_component(katex1.$$.fragment);
    			t2 = text(" is a finite sequence such that:");
    			ul1 = element("ul");
    			li1 = element("li");
    			t3 = text("For the first term ");
    			create_component(katex2.$$.fragment);
    			t4 = text(" of ");
    			create_component(katex3.$$.fragment);
    			t5 = text(",  ");
    			...
    			t7 = space();
    			li3 = element("li");
    			t8 = text("For all pair ");
    			create_component(katex5.$$.fragment);
    			t9 = text(" as a consecutive terms on ");
    			create_component(katex6.$$.fragment);
    			t10 = text(" where ");
    			create_component(katex7.$$.fragment);
    			t11 = text(" follows ");
    			...
    			li2 = element("li");
    			create_component(katex9.$$.fragment);
    			t13 = text(" is a member of ");
    			create_component(katex10.$$.fragment);
    			t14 = text(".");
    			t15 = space();
    			li4 = element("li");
    			t16 = text("For the last term ");
    			create_component(katex11.$$.fragment);
    			t17 = text(" of ");
    			create_component(katex12.$$.fragment);
    			t18 = text(", ");
    			create_component(katex13.$$.fragment);
    			t19 = text("is an empty set or not a set.");
    			add_location(li0, file$6, 42, 0, 3403);
    			add_location(li1, file$6, 44, 0, 3508);
    			add_location(li2, file$6, 46, 0, 3773);
    			add_location(ul0, file$6, 45, 153, 3768);
    			add_location(li3, file$6, 45, 0, 3615);
    			add_location(li4, file$6, 49, 0, 3856);
    			add_location(ul1, file$6, 43, 58, 3503);
    			add_location(li5, file$6, 43, 0, 3445);
    			add_location(ul2, file$6, 41, 5, 3398);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(ul2, t1);
    			append_dev(ul2, li5);
    			mount_component(katex1, li5, null);
    			append_dev(li5, t2);
    			append_dev(li5, ul1);
    			append_dev(ul1, li1);
    			append_dev(li1, t3);
    			mount_component(katex2, li1, null);
    			append_dev(li1, t4);
    			mount_component(katex3, li1, null);
    			append_dev(li1, t5);
    			mount_component(katex4, li1, null);
    			...
    			append_dev(ul1, li3);
    			append_dev(li3, t8);
    			mount_component(katex5, li3, null);
    			append_dev(li3, t9);
    			mount_component(katex6, li3, null);
    			append_dev(li3, t10);
    			mount_component(katex7, li3, null);
    			append_dev(li3, t11);
    			mount_component(katex8, li3, null);
    			append_dev(li3, t12);
    			append_dev(li3, ul0);
    			append_dev(ul0, li2);
    			mount_component(katex9, li2, null);
    			append_dev(li2, t13);
    			mount_component(katex10, li2, null);
    			append_dev(li2, t14);
    			append_dev(ul1, t15);
    			append_dev(ul1, li4);
    			append_dev(li4, t16);
    			mount_component(katex11, li4, null);
    			append_dev(li4, t17);
    			mount_component(katex12, li4, null);
    			append_dev(li4, t18);
    			mount_component(katex13, li4, null);
    ...
    function create_default_slot_11(ctx) {
    	...
    	let t1;
    	let current;
    	katex0 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex1 = new Katex({ props: { latex: "S" }, $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(katex0.$$.fragment);
    			t0 = text(" is said a completed chain by set member ship with ");
    			create_component(katex1.$$.fragment);
    			t1 = text(" as the root.");
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_10(ctx) {
    	...
    	katex3 = new Katex({ props: { latex: "|" }, $$inline: true });
    	...
    	katex5 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex6 = new Katex({ props: { latex: "p\\}" }, $$inline: true });
    	katex7 = new Katex({ props: { latex: "S2" }, $$inline: true });
    	katex8 = new Katex({ props: { latex: "S1" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			li0 = element("li");
    			create_component(katex0.$$.fragment);
    			t0 = text(" is the set of all completed chains by set member ship with ");
    			create_component(katex1.$$.fragment);
    			t1 = text(" as the root.");
    			t2 = space();
    			li1 = element("li");
    			...
    			create_component(katex9.$$.fragment);
    			t10 = text(".");
    			add_location(li0, file$6, 59, 0, 4277);
    			add_location(li1, file$6, 60, 0, 4404);
    			add_location(li2, file$6, 61, 0, 4575);
    			add_location(ul, file$6, 58, 5, 4272);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(katex4, li1, null);
    			append_dev(li1, t5);
    			mount_component(katex5, li1, null);
    			append_dev(li1, t6);
    			mount_component(katex6, li1, null);
    			append_dev(ul, t7);
    			append_dev(ul, li2);
    			mount_component(katex7, li2, null);
    			append_dev(li2, t8);
    ...
    function create_default_slot_9(ctx) {
    	...
    	let t1;
    	let current;
    	katex = new Katex({ props: { latex: "S2" }, $$inline: true });

    	const block = {
    		c: function create() {
    			ul = element("ul");
    			li = element("li");
    			t0 = text("To fall in all super set of ");
    			create_component(katex.$$.fragment);
    			t1 = text(".");
    			add_location(li, file$6, 66, 0, 4746);
    			add_location(ul, file$6, 65, 5, 4741);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li);
    			append_dev(li, t0);
    			mount_component(katex, li, null);
    			append_dev(li, t1);
    			current = true;
    		},
    		p: noop,
    ...
    function create_default_slot_8(ctx) {
    	...
    	katex1 = new Katex({ props: { latex: "|" }, $$inline: true });
    	...
    	katex3 = new Katex({ props: { latex: "v" }, $$inline: true });
    	katex4 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex5 = new Katex({ props: { latex: "\\}" }, $$inline: true });
    	...
    	katex7 = new Katex({ props: { latex: "|" }, $$inline: true });
    	...
    	katex10 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex11 = new Katex({ props: { latex: "\\}" }, $$inline: true });

    	katex12 = new Katex({
    			props: { latex: "v2\\in v1" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = text(", ");
    			create_component(katex9.$$.fragment);
    			t10 = text(" is a pair of consecutive terms on ");
    			create_component(katex10.$$.fragment);
    			t11 = space();
    			create_component(katex11.$$.fragment);
    			t12 = text(".");
    			...
    			create_component(katex12.$$.fragment);
    			t14 = text(".");
    			add_location(li0, file$6, 71, 0, 4950);
    			add_location(li1, file$6, 73, 0, 5354);
    			add_location(ul0, file$6, 72, 213, 5349);
    			add_location(li2, file$6, 72, 0, 5136);
    			add_location(ul1, file$6, 70, 5, 4945);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(katex2, li0, null);
    			append_dev(li0, t2);
    			mount_component(katex3, li0, null);
    			append_dev(li0, t3);
    			mount_component(katex4, li0, null);
    			append_dev(li0, t4);
    			mount_component(katex5, li0, null);
    			append_dev(li0, t5);
    			append_dev(ul1, t6);
    			append_dev(ul1, li2);
    			mount_component(katex6, li2, null);
    			...
    			mount_component(katex10, li2, null);
    			append_dev(li2, t11);
    			mount_component(katex11, li2, null);
    			append_dev(li2, t12);
    			append_dev(li2, ul0);
    			append_dev(ul0, li1);
    			append_dev(li1, t13);
    			mount_component(katex12, li1, null);
    			append_dev(li1, t14);
    			current = true;
    		},
    		p: noop,
    ...
    function create_default_slot_7(ctx) {
    	...
    	let current;
    	katex0 = new Katex({ props: { latex: "p" }, $$inline: true });
    	katex1 = new Katex({ props: { latex: "p,q" }, $$inline: true });
    	katex2 = new Katex({ props: { latex: "q" }, $$inline: true });

    	const block = {
    		c: function create() {
    			ul1 = element("ul");
    			li0 = element("li");
    			li0.textContent = "All set is not said a point (in the sense of this article).";
    			t1 = space();
    			li1 = element("li");
    			li1.textContent = "All two points are isomorphic to each other.";
    			t3 = space();
    			li3 = element("li");
    			t4 = text("That ");
    			create_component(katex0.$$.fragment);
    			t5 = text(" is a point and ");
    			create_component(katex1.$$.fragment);
    			t6 = text(" are isomorphic to each other implies that:");
    			ul0 = element("ul");
    			li2 = element("li");
    			create_component(katex2.$$.fragment);
    			t7 = text(" is a point.");
    			add_location(li0, file$6, 80, 0, 5505);
    			add_location(li1, file$6, 81, 0, 5574);
    			add_location(li2, file$6, 83, 0, 5747);
    			add_location(ul0, file$6, 82, 114, 5742);
    			add_location(li3, file$6, 82, 0, 5628);
    			add_location(ul1, file$6, 79, 5, 5500);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul1, anchor);
    			append_dev(ul1, li0);
    			...
    			append_dev(ul1, li3);
    			append_dev(li3, t4);
    			mount_component(katex0, li3, null);
    			append_dev(li3, t5);
    			mount_component(katex1, li3, null);
    			append_dev(li3, t6);
    			append_dev(li3, ul0);
    			append_dev(ul0, li2);
    ...
    function create_default_slot_6(ctx) {
    	...
    	let t6;
    	let current;
    	katex0 = new Katex({ props: { latex: "f" }, $$inline: true });
    	...
    	katex2 = new Katex({ props: { latex: "f" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t0 = text("Some such isomorphism ");
    			create_component(katex0.$$.fragment);
    			t1 = text(" exists between their trees in terms of graph theory that:");
    			t2 = space();
    			ul1 = element("ul");
    			li1 = element("li");
    			t3 = text("For all point ");
    			create_component(katex1.$$.fragment);
    			t4 = text(" image(");
    			create_component(katex2.$$.fragment);
    			t5 = text("):");
    			...
    			li0 = element("li");
    			create_component(katex3.$$.fragment);
    			t6 = text(" are isomorphic to each other.");
    			add_location(p, file$6, 90, 5, 5937);
    			add_location(li0, file$6, 93, 0, 6132);
    			add_location(ul0, file$6, 92, 75, 6127);
    			add_location(li1, file$6, 92, 0, 6052);
    			add_location(ul1, file$6, 91, 0, 6047);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    			mount_component(katex0, p, null);
    			append_dev(p, t1);
    			insert_dev(target, t2, anchor);
    			insert_dev(target, ul1, anchor);
    			append_dev(ul1, li1);
    ...
    function create_default_slot_5(ctx) {
    	...
    	let t5;
    	let current;
    	katex0 = new Katex({ props: { latex: "X" }, $$inline: true });
    	katex1 = new Katex({ props: { latex: "M" }, $$inline: true });
    	katex2 = new Katex({ props: { latex: "X" }, $$inline: true });
    	...
    	katex4 = new Katex({ props: { latex: "n" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			li0 = element("li");
    			create_component(katex0.$$.fragment);
    			t0 = text(" is a set of points.");
    			t1 = space();
    			li1 = element("li");
    			create_component(katex1.$$.fragment);
    			t2 = text(" is a metric table on ");
    			create_component(katex2.$$.fragment);
    			t3 = text(" to define ");
    			create_component(katex3.$$.fragment);
    			t4 = text(" as an ");
    			create_component(katex4.$$.fragment);
    			t5 = text("-dimensional Euclidean space.");
    			add_location(li0, file$6, 101, 0, 6372);
    			add_location(li1, file$6, 102, 0, 6424);
    			add_location(ul, file$6, 100, 5, 6367);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    ...
    function create_default_slot_4(ctx) {
    	...
    	let t13;
    	let current;
    	katex0 = new Katex({ props: { latex: "S:=d" }, $$inline: true });
    	katex1 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	katex3 = new Katex({ props: { latex: "d" }, $$inline: true });
    	...
    	katex7 = new Katex({ props: { latex: "S" }, $$inline: true });
    	katex8 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("Let ");
    			create_component(katex0.$$.fragment);
    			t1 = text(" denote the definition of ");
    			create_component(katex1.$$.fragment);
    			t2 = text(" in terms of ");
    			create_component(katex2.$$.fragment);
    			t3 = text(". ");
    			...
    			t4 = text("That is, ");
    			create_component(katex3.$$.fragment);
    			t5 = text(" does not define ");
    			create_component(katex4.$$.fragment);
    			t6 = text(" but refers to ");
    			create_component(katex5.$$.fragment);
    			t7 = text(" as the predefined context.");
    			t8 = space();
    			li3 = element("li");
    			t9 = text("For the repetitive expression as ");
    			create_component(katex6.$$.fragment);
    			t10 = text(":");
    			ul1 = element("ul");
    			li2 = element("li");
    			t11 = text("The first ");
    			create_component(katex7.$$.fragment);
    			t12 = text(" is identical to the second ");
    			create_component(katex8.$$.fragment);
    			t13 = text(".");
    			add_location(li0, file$6, 110, 0, 6979);
    			add_location(ul0, file$6, 109, 122, 6974);
    			add_location(li1, file$6, 109, 0, 6852);
    			add_location(li2, file$6, 114, 0, 7216);
    			add_location(ul1, file$6, 113, 68, 7211);
    			add_location(li3, file$6, 113, 0, 7143);
    			add_location(ul2, file$6, 108, 5, 6847);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul2, anchor);
    			append_dev(ul2, li1);
    			append_dev(li1, t0);
    			mount_component(katex0, li1, null);
    			append_dev(li1, t1);
    			mount_component(katex1, li1, null);
    			append_dev(li1, t2);
    			mount_component(katex2, li1, null);
    ...
    function create_default_slot_3(ctx) {
    	...
    	katex3 = new Katex({
    			props: { latex: "\\forall S1" },
    			$$inline: true
    		});

    	katex4 = new Katex({
    			props: { latex: "S1 \\in \\Psi_S" },
    			$$inline: true
    		});
    	...
    	katex13 = new Katex({ props: { latex: "(f)" }, $$inline: true });
    	katex14 = new Katex({ props: { latex: "y" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			li0 = element("li");
    			create_component(katex0.$$.fragment);
    			t0 = text(" is a set to fall in ");
    			create_component(katex1.$$.fragment);
    			t1 = text(".");
    			t2 = space();
    			li4 = element("li");
    			create_component(katex2.$$.fragment);
    			t3 = text(" is the set such that:");
    			ul1 = element("ul");
    			li2 = element("li");
    			create_component(katex3.$$.fragment);
    			t4 = text(", ");
    			create_component(katex4.$$.fragment);
    			t5 = text(" is equivalent to that:");
    			ul0 = element("ul");
    			li1 = element("li");
    			create_component(katex5.$$.fragment);
    			t6 = text(" is isomorphic to ");
    			create_component(katex6.$$.fragment);
    			t7 = text(".");
    			t8 = space();
    			li3 = element("li");
    			create_component(katex7.$$.fragment);
    			t9 = text(" is specified in terms of ");
    			create_component(katex8.$$.fragment);
    			t10 = text(".");
    			t11 = space();
    			li5 = element("li");
    			create_component(katex9.$$.fragment);
    			t12 = text(" is a specifed function on ");
    			create_component(katex10.$$.fragment);
    			t13 = text(" in terms of ");
    			create_component(katex11.$$.fragment);
    			t14 = text(".");
    			t15 = space();
    			li6 = element("li");
    			...
    			t17 = text(" and ");
    			create_component(katex14.$$.fragment);
    			t18 = text(" is specified in terms of ");
    			create_component(katex15.$$.fragment);
    			t19 = text(".");
    			t20 = space();
    			li9 = element("li");
    			create_component(katex16.$$.fragment);
    			t21 = text(" is the subset of ");
    			create_component(katex17.$$.fragment);
    			t22 = text(" such that:");
    			ul3 = element("ul");
    			li8 = element("li");
    			create_component(katex18.$$.fragment);
    			t23 = text(" is equivalent to that:");
    			ul2 = element("ul");
    			li7 = element("li");
    			create_component(katex19.$$.fragment);
    			t24 = text(".");
    			add_location(li0, file$6, 133, 0, 8766);
    			add_location(li1, file$6, 136, 0, 9003);
    			add_location(ul0, file$6, 135, 97, 8998);
    			add_location(li2, file$6, 135, 0, 8901);
    			add_location(li3, file$6, 139, 0, 9097);
    			add_location(ul1, file$6, 134, 54, 8896);
    			add_location(li4, file$6, 134, 0, 8842);
    			add_location(li5, file$6, 142, 0, 9200);
    			add_location(li6, file$6, 143, 0, 9327);
    			add_location(li7, file$6, 146, 0, 9651);
    			add_location(ul2, file$6, 145, 71, 9646);
    			add_location(li8, file$6, 145, 0, 9575);
    			add_location(ul3, file$6, 144, 97, 9570);
    			add_location(li9, file$6, 144, 0, 9473);
    			add_location(ul4, file$6, 132, 5, 8761);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(ul4, t2);
    			append_dev(ul4, li4);
    			mount_component(katex2, li4, null);
    			append_dev(li4, t3);
    			append_dev(li4, ul1);
    			append_dev(ul1, li2);
    			mount_component(katex3, li2, null);
    			append_dev(li2, t4);
    			mount_component(katex4, li2, null);
    			append_dev(li2, t5);
    			append_dev(li2, ul0);
    			append_dev(ul0, li1);
    			mount_component(katex5, li1, null);
    			...
    			append_dev(ul4, t11);
    			append_dev(ul4, li5);
    			mount_component(katex9, li5, null);
    			append_dev(li5, t12);
    			mount_component(katex10, li5, null);
    			append_dev(li5, t13);
    			mount_component(katex11, li5, null);
    			append_dev(li5, t14);
    			append_dev(ul4, t15);
    			append_dev(ul4, li6);
    			mount_component(katex12, li6, null);
    			append_dev(li6, t16);
    			mount_component(katex13, li6, null);
    			append_dev(li6, t17);
    			mount_component(katex14, li6, null);
    			append_dev(li6, t18);
    			mount_component(katex15, li6, null);
    			append_dev(li6, t19);
    			append_dev(ul4, t20);
    			append_dev(ul4, li9);
    			mount_component(katex16, li9, null);
    			append_dev(li9, t21);
    			mount_component(katex17, li9, null);
    			append_dev(li9, t22);
    			append_dev(li9, ul3);
    			append_dev(ul3, li8);
    			mount_component(katex18, li8, null);
    			append_dev(li8, t23);
    			append_dev(li8, ul2);
    			append_dev(ul2, li7);
    			mount_component(katex19, li7, null);
    			append_dev(li7, t24);
    			current = true;
    		},
    		p: noop,
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(katex.$$.fragment);
    			t = text(".");
    			add_location(li, file$6, 156, 0, 9923);
    			add_location(ul, file$6, 155, 5, 9918);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li);
    ...
    function create_default_slot_1(ctx) {
    	...
    	let current;
    	katex0 = new Katex({ props: { latex: "F" }, $$inline: true });
    	katex1 = new Katex({ props: { latex: "S1" }, $$inline: true });
    	katex2 = new Katex({ props: { latex: "S2" }, $$inline: true });
    	katex3 = new Katex({ props: { latex: "F" }, $$inline: true });
    	katex4 = new Katex({ props: { latex: "S1" }, $$inline: true });
    	katex5 = new Katex({ props: { latex: "S3" }, $$inline: true });
    	katex6 = new Katex({ props: { latex: "S2" }, $$inline: true });

    	katex7 = new Katex({
    			props: { latex: "S3 \\in \\psi_{(S,f,y)}" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(katex7.$$.fragment);
    			t9 = text(".");
    			add_location(li0, file$6, 161, 0, 10151);
    			add_location(li1, file$6, 162, 0, 10241);
    			add_location(ul, file$6, 160, 5, 10146);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    			...
    			mount_component(katex6, li1, null);
    			append_dev(li1, t8);
    			mount_component(katex7, li1, null);
    			append_dev(li1, t9);
    			current = true;
    		},
    		p: noop,
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t0 = text("To divide ");
    			create_component(katex.$$.fragment);
    			t1 = text(" by connectivity through ambient isotopies.");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t0, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	katex1 = new Katex({ props: { latex: "K" }, $$inline: true });
    	katex2 = new Katex({ props: { latex: "f" }, $$inline: true });
    	...
    	badge1 = new Badge({
    			props: { type: "Def", num: "1" },
    			$$inline: true
    		});

    	katex9 = new Katex({ props: { latex: "S,p" }, $$inline: true });
    	...
    	badge2 = new Badge({
    			props: { type: "Def", num: "2" },
    			$$inline: true
    		});

    	katex10 = new Katex({
    			props: { latex: "S,P,S1,S2" },
    			$$inline: true
    		});
    	...
    	katex11 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	katex12 = new Katex({ props: { latex: "P" }, $$inline: true });
    	katex13 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	badge6 = new Badge({
    			props: { type: "Def", num: "6" },
    			$$inline: true
    		});

    	katex16 = new Katex({ props: { latex: "S" }, $$inline: true });
    	katex17 = new Katex({ props: { latex: "X" }, $$inline: true });
    	katex18 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	badge7 = new Badge({
    			props: { type: "Example", num: "1" },
    			$$inline: true
    		});

    	katex20 = new Katex({ props: { latex: "S:=d" }, $$inline: true });
    	katex21 = new Katex({ props: { latex: "X" }, $$inline: true });
    	...
    	katex23 = new Katex({ props: { latex: "S" }, $$inline: true });
    	katex24 = new Katex({ props: { latex: "S=X" }, $$inline: true });
    	katex25 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	katex27 = new Katex({ props: { latex: "S:=d" }, $$inline: true });
    	katex28 = new Katex({ props: { latex: "X" }, $$inline: true });
    	...
    	katex31 = new Katex({ props: { latex: "S" }, $$inline: true });
    	katex32 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	katex34 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex35 = new Katex({ props: { latex: "X" }, $$inline: true });
    	katex36 = new Katex({ props: { latex: "S:=d" }, $$inline: true });
    	katex37 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex38 = new Katex({ props: { latex: "S" }, $$inline: true });
    	...
    	katex41 = new Katex({ props: { latex: "d" }, $$inline: true });
    	katex42 = new Katex({ props: { latex: "x" }, $$inline: true });
    	katex43 = new Katex({ props: { latex: "d" }, $$inline: true });
    	katex44 = new Katex({ props: { latex: "x" }, $$inline: true });

    	badge8 = new Badge({
    			props: { type: "Def", num: "7" },
    			$$inline: true
    		});
    	...
    	katex46 = new Katex({
    			props: { latex: "S,\\Psi_S,f,\\psi_{(S,f,y)}" },
    			$$inline: true
    		});
    	...
    	katex50 = new Katex({ props: { latex: "F" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(svlt.$$.fragment);
    			t1 = space();
    			h20 = element("h2");
    			h20.textContent = "Summary";
    			t3 = space();
    			p0 = element("p");
    			t4 = text("In this summary,");
    			span0 = element("span");
    			span0.textContent = "words";
    			t6 = text("\n in blue are expected to be trivial for readers although it will be defined in the main text; \n");
    			span1 = element("span");
    			span1.textContent = "words";
    			t8 = text("\n in red are meant to remain abstract.");
    			t9 = space();
    			p1 = element("p");
    			p1.textContent = "The author once tried but failed to state that:";
    			t11 = space();
    			create_component(box0.$$.fragment);
    			t12 = space();
    			p2 = element("p");
    			t13 = text("For example, ");
    			create_component(katex0.$$.fragment);
    			t14 = text(" \"the probabilistically expected number of crossings on a projection of ");
    			create_component(katex1.$$.fragment);
    			t15 = text("\".\nBut it was too hard to redefine the abstract term \"");
    			create_component(katex2.$$.fragment);
    			t16 = space();
    			span2 = element("span");
    			span2.textContent = "naturally";
    			t18 = text(" maps ...\" in strict words. For example ");
    			create_component(katex3.$$.fragment);
    			t19 = text(" \"the length of ");
    			create_component(katex4.$$.fragment);
    			t20 = text("\" is to be said natural whereas ");
    			create_component(katex5.$$.fragment);
    			t21 = text(" is not to be said natural because it is a trivial counterexample.");
    			t22 = space();
    			p3 = element("p");
    			t23 = text("Notice that, in general, ");
    			create_component(katex6.$$.fragment);
    			t24 = text(" is a union of sets where each component set can be defined in a shorter text than ");
    			create_component(katex7.$$.fragment);
    			t25 = text(".");
    			t26 = space();
    			p4 = element("p");
    			p4.textContent = "As an improvement of the above failure, the author introduces Axiom of Definition length.";
    			t28 = space();
    			p5 = element("p");
    			p5.textContent = "We give the axiom first then we give definitions for the used words, symbols and notations. Please be patient for that it may sound nothing until you have read at least a half of the page.";
    			t30 = space();
    			h21 = element("h2");
    			create_component(badge0.$$.fragment);
    			t31 = space();
    			p6 = element("p");
    			t32 = text("For all set denoted as ");
    			create_component(katex8.$$.fragment);
    			t33 = text(", if it is divided by the connectivity through ambient isotopies into multiple components then:");
    			t34 = space();
    			create_component(box1.$$.fragment);
    			t35 = space();
    			h22 = element("h2");
    			h22.textContent = "Definitions";
    			t37 = space();
    			h30 = element("h3");
    			create_component(badge1.$$.fragment);
    			t38 = text("A completed chain by set member ship");
    			t39 = space();
    			p7 = element("p");
    			t40 = text("Let ");
    			create_component(katex9.$$.fragment);
    			t41 = text(" be all such that:");
    			t42 = space();
    			...
    			t47 = text("A set to fall in a set");
    			t48 = space();
    			p9 = element("p");
    			t49 = text("Let ");
    			create_component(katex10.$$.fragment);
    			t50 = text(" be all such that:");
    			t51 = space();
    			...
    			t56 = space();
    			p11 = element("p");
    			t57 = text("Besides, we regard ");
    			create_component(katex12.$$.fragment);
    			t58 = text(" as the tree to represent ");
    			create_component(katex13.$$.fragment);
    			t59 = text(" in the sense of that:");
    			t60 = space();
    			create_component(box6.$$.fragment);
    			t61 = space();
    			h32 = element("h3");
    			create_component(badge3.$$.fragment);
    			t62 = text("Isomorphisms of points");
    			t63 = space();
    			create_component(box7.$$.fragment);
    			t64 = space();
    			h33 = element("h3");
    			create_component(badge4.$$.fragment);
    			t65 = text("Isomorphisms of sets");
    			t66 = space();
    			p12 = element("p");
    			p12.textContent = "Two sets are said isomorphic to each other if:";
    			t68 = space();
    			create_component(box8.$$.fragment);
    			t69 = space();
    			h34 = element("h3");
    			create_component(badge5.$$.fragment);
    			t70 = text("Definition of ");
    			create_component(katex14.$$.fragment);
    			t71 = space();
    			p13 = element("p");
    			t72 = text("Let ");
    			create_component(katex15.$$.fragment);
    			t73 = text(" be all such that:");
    			t74 = space();
    			create_component(box9.$$.fragment);
    			t75 = space();
    			h35 = element("h3");
    			create_component(badge6.$$.fragment);
    			t76 = text("Specified sets");
    			t77 = space();
    			p14 = element("p");
    			t78 = text("Let ");
    			create_component(katex16.$$.fragment);
    			t79 = text(" be all which falls in ");
    			create_component(katex17.$$.fragment);
    			t80 = text(".");
    			t81 = space();
    			p15 = element("p");
    			t82 = text("Then ");
    			create_component(katex18.$$.fragment);
    			t83 = text(" is said specified in terms of ");
    			create_component(katex19.$$.fragment);
    			t84 = text(" if:");
    			t85 = space();
    			create_component(box10.$$.fragment);
    			t86 = space();
    			h36 = element("h3");
    			...
    			t88 = text("Let ");
    			create_component(katex20.$$.fragment);
    			t89 = text(" as \"the set of all points of ");
    			create_component(katex21.$$.fragment);
    			t90 = text("\".");
    			t91 = space();
    			p17 = element("p");
    			t92 = text("Let us define, ");
    			create_component(katex22.$$.fragment);
    			t93 = text(". Then the two ");
    			create_component(katex23.$$.fragment);
    			t94 = text(" are identical because ");
    			create_component(katex24.$$.fragment);
    			t95 = text(". Hence ");
    			create_component(katex25.$$.fragment);
    			t96 = text(" is specified in terms of ");
    			create_component(katex26.$$.fragment);
    			t97 = text(".");
    			t98 = space();
    			br1 = element("br");
    			...
    			p18 = element("p");
    			t100 = text("Let ");
    			create_component(katex27.$$.fragment);
    			t101 = text(" as \"all subset of ");
    			create_component(katex28.$$.fragment);
    			t102 = text(" such that ");
    			create_component(katex29.$$.fragment);
    			t103 = text("\".");
    			t104 = space();
    			p19 = element("p");
    			t105 = text("Let us define, ");
    			create_component(katex30.$$.fragment);
    			t106 = text(". Then the two ");
    			create_component(katex31.$$.fragment);
    			t107 = text(" are not identical in general. Hence ");
    			create_component(katex32.$$.fragment);
    			t108 = text(" is not specified in terms of ");
    			create_component(katex33.$$.fragment);
    			t109 = text(".");
    			t110 = space();
    			br2 = element("br");
    			t111 = space();
    			p20 = element("p");
    			t112 = text("Let ");
    			create_component(katex34.$$.fragment);
    			t113 = text(" be all point in ");
    			create_component(katex35.$$.fragment);
    			t114 = text(".\nLet ");
    			create_component(katex36.$$.fragment);
    			t115 = text(" as \"the set of all points of distance 1 to ");
    			create_component(katex37.$$.fragment);
    			t116 = text("\".");
    			t117 = space();
    			p21 = element("p");
    			t118 = text("Then ");
    			create_component(katex38.$$.fragment);
    			t119 = text(" is specified in terms of ");
    			create_component(katex39.$$.fragment);
    			t120 = text(" but in terms of ");
    			create_component(katex40.$$.fragment);
    			t121 = text(".");
    			t122 = space();
    			p22 = element("p");
    			t123 = text("The difference is between that ");
    			create_component(katex41.$$.fragment);
    			t124 = text(" refers ");
    			create_component(katex42.$$.fragment);
    			t125 = text(" as the predefined context and that ");
    			create_component(katex43.$$.fragment);
    			t126 = text(" defines ");
    			create_component(katex44.$$.fragment);
    			t127 = text(" within it when it is repititively expressed.");
    			t128 = space();
    			h37 = element("h3");
    			create_component(badge8.$$.fragment);
    			t129 = text("Definition of ");
    			create_component(katex45.$$.fragment);
    			t130 = space();
    			p23 = element("p");
    			t131 = text("Let ");
    			create_component(katex46.$$.fragment);
    			t132 = text(" be all such that:");
    			t133 = space();
    			create_component(box11.$$.fragment);
    			t134 = space();
    			h38 = element("h3");
    			create_component(badge9.$$.fragment);
    			t135 = text("To divide ");
    			create_component(katex47.$$.fragment);
    			t136 = text(" by connectivity through ambient isotopies");
    			t137 = space();
    			p24 = element("p");
    			t138 = text("Let ");
    			create_component(katex48.$$.fragment);
    			t139 = text(" be all such that:");
    			t140 = space();
    			create_component(box12.$$.fragment);
    			t141 = space();
    			p25 = element("p");
    			create_component(katex49.$$.fragment);
    			t142 = text(" are said connected through an ambient isotopy ");
    			create_component(katex50.$$.fragment);
    			t143 = text(" on ");
    			create_component(katex51.$$.fragment);
    			t144 = text(" if:");
    			t145 = space();
    			create_component(box13.$$.fragment);
    			t146 = space();
    			p26 = element("p");
    			t147 = text("To diveide ");
    			create_component(katex52.$$.fragment);
    			t148 = text(" by this relation is said:");
    			t149 = space();
    			create_component(box14.$$.fragment);
    			add_location(br0, file$6, 0, 0, 0);
    			attr_dev(center, "class", "bg-white2");
    			add_location(center, file$6, 1, 0, 6);
    			add_location(h20, file$6, 5, 0, 165);
    			set_style(span0, "color", "blue");
    			add_location(span0, file$6, 6, 19, 201);
    			set_style(span1, "color", "red");
    			add_location(span1, file$6, 8, 0, 337);
    			add_location(p0, file$6, 6, 0, 182);
    			add_location(p1, file$6, 10, 0, 419);
    			set_style(span2, "color", "red");
    			add_location(span2, file$6, 31, 79, 2069);
    			add_location(p2, file$6, 30, 0, 1840);
    			add_location(p3, file$6, 32, 0, 2373);
    			add_location(p4, file$6, 33, 0, 2562);
    			add_location(p5, file$6, 34, 0, 2660);
    			add_location(h21, file$6, 35, 0, 2856);
    			add_location(p6, file$6, 36, 0, 2900);
    			add_location(h22, file$6, 38, 0, 3240);
    			add_location(h30, file$6, 39, 0, 3261);
    			add_location(p7, file$6, 40, 0, 3339);
    			add_location(p8, file$6, 54, 0, 4010);
    			add_location(h31, file$6, 56, 0, 4143);
    			add_location(p9, file$6, 57, 0, 4207);
    			add_location(p10, file$6, 64, 0, 4692);
    			add_location(p11, file$6, 69, 0, 4821);
    			add_location(h32, file$6, 78, 0, 5431);
    			add_location(h33, file$6, 88, 0, 5816);
    			add_location(p12, file$6, 89, 0, 5878);
    			add_location(h34, file$6, 98, 0, 6224);
    			add_location(p13, file$6, 99, 0, 6306);
    			add_location(h35, file$6, 105, 0, 6609);
    			add_location(p14, file$6, 106, 0, 6665);
    			add_location(p15, file$6, 107, 0, 6746);
    			add_location(h36, file$6, 119, 0, 7334);
    			add_location(p16, file$6, 120, 0, 7380);
    			add_location(p17, file$6, 121, 0, 7481);
    			add_location(br1, file$6, 122, 0, 7701);
    			add_location(p18, file$6, 123, 0, 7707);
    			add_location(p19, file$6, 124, 0, 7834);
    			add_location(br2, file$6, 125, 0, 8040);
    			add_location(p20, file$6, 126, 0, 8046);
    			add_location(p21, file$6, 128, 0, 8228);
    			add_location(p22, file$6, 129, 0, 8361);
    			add_location(h37, file$6, 130, 0, 8586);
    			add_location(p23, file$6, 131, 0, 8678);
    			add_location(h38, file$6, 153, 0, 9727);
    			add_location(p24, file$6, 154, 0, 9857);
    			add_location(p25, file$6, 159, 0, 10004);
    			add_location(p26, file$6, 165, 0, 10425);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(svlt, center, null);
    			insert_dev(target, t1, anchor);
    			...
    			append_dev(p2, span2);
    			append_dev(p2, t18);
    			mount_component(katex3, p2, null);
    			append_dev(p2, t19);
    			mount_component(katex4, p2, null);
    			append_dev(p2, t20);
    			mount_component(katex5, p2, null);
    			append_dev(p2, t21);
    			insert_dev(target, t22, anchor);
    			insert_dev(target, p3, anchor);
    			append_dev(p3, t23);
    			mount_component(katex6, p3, null);
    			append_dev(p3, t24);
    			mount_component(katex7, p3, null);
    			append_dev(p3, t25);
    			...
    			mount_component(badge0, h21, null);
    			...
    			mount_component(badge1, h30, null);
    			append_dev(h30, t38);
    			insert_dev(target, t39, anchor);
    			insert_dev(target, p7, anchor);
    			append_dev(p7, t40);
    			mount_component(katex9, p7, null);
    			append_dev(p7, t41);
    			...
    			mount_component(badge2, h31, null);
    			append_dev(h31, t47);
    			insert_dev(target, t48, anchor);
    			insert_dev(target, p9, anchor);
    			append_dev(p9, t49);
    			mount_component(katex10, p9, null);
    			append_dev(p9, t50);
    			...
    			append_dev(p10, t53);
    			mount_component(katex11, p10, null);
    			append_dev(p10, t54);
    			...
    			append_dev(p11, t57);
    			mount_component(katex12, p11, null);
    			append_dev(p11, t58);
    			mount_component(katex13, p11, null);
    			append_dev(p11, t59);
    			insert_dev(target, t60, anchor);
    			mount_component(box6, target, anchor);
    			insert_dev(target, t61, anchor);
    			insert_dev(target, h32, anchor);
    			mount_component(badge3, h32, null);
    			append_dev(h32, t62);
    			insert_dev(target, t63, anchor);
    			mount_component(box7, target, anchor);
    			insert_dev(target, t64, anchor);
    			insert_dev(target, h33, anchor);
    			mount_component(badge4, h33, null);
    			append_dev(h33, t65);
    			...
    			mount_component(badge5, h34, null);
    			append_dev(h34, t70);
    			mount_component(katex14, h34, null);
    			insert_dev(target, t71, anchor);
    			insert_dev(target, p13, anchor);
    			append_dev(p13, t72);
    			mount_component(katex15, p13, null);
    			append_dev(p13, t73);
    			insert_dev(target, t74, anchor);
    			mount_component(box9, target, anchor);
    			insert_dev(target, t75, anchor);
    			insert_dev(target, h35, anchor);
    			mount_component(badge6, h35, null);
    			append_dev(h35, t76);
    			insert_dev(target, t77, anchor);
    			insert_dev(target, p14, anchor);
    			append_dev(p14, t78);
    			mount_component(katex16, p14, null);
    			append_dev(p14, t79);
    			mount_component(katex17, p14, null);
    			append_dev(p14, t80);
    			insert_dev(target, t81, anchor);
    			insert_dev(target, p15, anchor);
    			append_dev(p15, t82);
    			mount_component(katex18, p15, null);
    			append_dev(p15, t83);
    			mount_component(katex19, p15, null);
    			append_dev(p15, t84);
    			insert_dev(target, t85, anchor);
    			mount_component(box10, target, anchor);
    			insert_dev(target, t86, anchor);
    			insert_dev(target, h36, anchor);
    			mount_component(badge7, h36, null);
    			insert_dev(target, t87, anchor);
    			insert_dev(target, p16, anchor);
    			append_dev(p16, t88);
    			mount_component(katex20, p16, null);
    			append_dev(p16, t89);
    			mount_component(katex21, p16, null);
    			append_dev(p16, t90);
    			insert_dev(target, t91, anchor);
    			insert_dev(target, p17, anchor);
    			append_dev(p17, t92);
    			mount_component(katex22, p17, null);
    			append_dev(p17, t93);
    			mount_component(katex23, p17, null);
    			append_dev(p17, t94);
    			mount_component(katex24, p17, null);
    			append_dev(p17, t95);
    			mount_component(katex25, p17, null);
    			append_dev(p17, t96);
    			mount_component(katex26, p17, null);
    			append_dev(p17, t97);
    			...
    			append_dev(p18, t100);
    			mount_component(katex27, p18, null);
    			append_dev(p18, t101);
    			mount_component(katex28, p18, null);
    			append_dev(p18, t102);
    			mount_component(katex29, p18, null);
    			append_dev(p18, t103);
    			insert_dev(target, t104, anchor);
    			insert_dev(target, p19, anchor);
    			append_dev(p19, t105);
    			mount_component(katex30, p19, null);
    			append_dev(p19, t106);
    			mount_component(katex31, p19, null);
    			append_dev(p19, t107);
    			mount_component(katex32, p19, null);
    			append_dev(p19, t108);
    			mount_component(katex33, p19, null);
    			append_dev(p19, t109);
    			...
    			append_dev(p20, t112);
    			mount_component(katex34, p20, null);
    			append_dev(p20, t113);
    			mount_component(katex35, p20, null);
    			append_dev(p20, t114);
    			mount_component(katex36, p20, null);
    			append_dev(p20, t115);
    			mount_component(katex37, p20, null);
    			append_dev(p20, t116);
    			insert_dev(target, t117, anchor);
    			insert_dev(target, p21, anchor);
    			append_dev(p21, t118);
    			mount_component(katex38, p21, null);
    			append_dev(p21, t119);
    			mount_component(katex39, p21, null);
    			append_dev(p21, t120);
    			mount_component(katex40, p21, null);
    			append_dev(p21, t121);
    			insert_dev(target, t122, anchor);
    			insert_dev(target, p22, anchor);
    			append_dev(p22, t123);
    			mount_component(katex41, p22, null);
    			append_dev(p22, t124);
    			mount_component(katex42, p22, null);
    			append_dev(p22, t125);
    			mount_component(katex43, p22, null);
    			append_dev(p22, t126);
    			mount_component(katex44, p22, null);
    			append_dev(p22, t127);
    			insert_dev(target, t128, anchor);
    			insert_dev(target, h37, anchor);
    			mount_component(badge8, h37, null);
    			append_dev(h37, t129);
    			mount_component(katex45, h37, null);
    			insert_dev(target, t130, anchor);
    			insert_dev(target, p23, anchor);
    			append_dev(p23, t131);
    			mount_component(katex46, p23, null);
    			append_dev(p23, t132);
    			insert_dev(target, t133, anchor);
    			mount_component(box11, target, anchor);
    			insert_dev(target, t134, anchor);
    			insert_dev(target, h38, anchor);
    			mount_component(badge9, h38, null);
    			append_dev(h38, t135);
    			mount_component(katex47, h38, null);
    			append_dev(h38, t136);
    			insert_dev(target, t137, anchor);
    			insert_dev(target, p24, anchor);
    			append_dev(p24, t138);
    			mount_component(katex48, p24, null);
    			append_dev(p24, t139);
    			insert_dev(target, t140, anchor);
    			mount_component(box12, target, anchor);
    			insert_dev(target, t141, anchor);
    			insert_dev(target, p25, anchor);
    			mount_component(katex49, p25, null);
    			append_dev(p25, t142);
    			mount_component(katex50, p25, null);
    			append_dev(p25, t143);
    			mount_component(katex51, p25, null);
    			append_dev(p25, t144);
    			insert_dev(target, t145, anchor);
    			mount_component(box13, target, anchor);
    			insert_dev(target, t146, anchor);
    			insert_dev(target, p26, anchor);
    			append_dev(p26, t147);
    			mount_component(katex52, p26, null);
    			append_dev(p26, t148);
    			insert_dev(target, t149, anchor);
    			mount_component(box14, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const svlt_changes = {};
    			...
    			if (dirty & /*$$scope*/ 128) {
    				svlt_changes.$$scope = { dirty, ctx };
    			}

    			svlt.$set(svlt_changes);
    			const box0_changes = {};
    			...
    			if (dirty & /*$$scope*/ 128) {
    				box10_changes.$$scope = { dirty, ctx };
    			}

    			box10.$set(box10_changes);
    			const box11_changes = {};

    			if (dirty & /*$$scope*/ 128) {
    				box11_changes.$$scope = { dirty, ctx };
    			}

    			box11.$set(box11_changes);
    			const box12_changes = {};

    			if (dirty & /*$$scope*/ 128) {
    				box12_changes.$$scope = { dirty, ctx };
    			}

    			box12.$set(box12_changes);
    			const box13_changes = {};

    			if (dirty & /*$$scope*/ 128) {
    				box13_changes.$$scope = { dirty, ctx };
    			}

    			box13.$set(box13_changes);
    			const box14_changes = {};

    			if (dirty & /*$$scope*/ 128) {
    				box14_changes.$$scope = { dirty, ctx };
    			}

    			box14.$set(box14_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(svlt.$$.fragment, local);
    			...
    			transition_in(katex18.$$.fragment, local);
    			transition_in(katex19.$$.fragment, local);
    			transition_in(box10.$$.fragment, local);
    			...
    			transition_in(katex25.$$.fragment, local);
    			transition_in(katex26.$$.fragment, local);
    			transition_in(katex27.$$.fragment, local);
    			transition_in(katex28.$$.fragment, local);
    			transition_in(katex29.$$.fragment, local);
    			transition_in(katex30.$$.fragment, local);
    			transition_in(katex31.$$.fragment, local);
    			transition_in(katex32.$$.fragment, local);
    			transition_in(katex33.$$.fragment, local);
    			transition_in(katex34.$$.fragment, local);
    			transition_in(katex35.$$.fragment, local);
    			transition_in(katex36.$$.fragment, local);
    			transition_in(katex37.$$.fragment, local);
    			transition_in(katex38.$$.fragment, local);
    			transition_in(katex39.$$.fragment, local);
    			transition_in(katex40.$$.fragment, local);
    			transition_in(katex41.$$.fragment, local);
    			transition_in(katex42.$$.fragment, local);
    			transition_in(katex43.$$.fragment, local);
    			transition_in(katex44.$$.fragment, local);
    			transition_in(badge8.$$.fragment, local);
    			transition_in(katex45.$$.fragment, local);
    			transition_in(katex46.$$.fragment, local);
    			transition_in(box11.$$.fragment, local);
    			transition_in(badge9.$$.fragment, local);
    			transition_in(katex47.$$.fragment, local);
    			transition_in(katex48.$$.fragment, local);
    			transition_in(box12.$$.fragment, local);
    			transition_in(katex49.$$.fragment, local);
    			transition_in(katex50.$$.fragment, local);
    			transition_in(katex51.$$.fragment, local);
    			transition_in(box13.$$.fragment, local);
    			transition_in(katex52.$$.fragment, local);
    			transition_in(box14.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(svlt.$$.fragment, local);
    			...
    			transition_out(katex18.$$.fragment, local);
    			transition_out(katex19.$$.fragment, local);
    			transition_out(box10.$$.fragment, local);
    			...
    			transition_out(katex25.$$.fragment, local);
    			transition_out(katex26.$$.fragment, local);
    			transition_out(katex27.$$.fragment, local);
    			transition_out(katex28.$$.fragment, local);
    			transition_out(katex29.$$.fragment, local);
    			transition_out(katex30.$$.fragment, local);
    			transition_out(katex31.$$.fragment, local);
    			transition_out(katex32.$$.fragment, local);
    			transition_out(katex33.$$.fragment, local);
    			transition_out(katex34.$$.fragment, local);
    			transition_out(katex35.$$.fragment, local);
    			transition_out(katex36.$$.fragment, local);
    			transition_out(katex37.$$.fragment, local);
    			transition_out(katex38.$$.fragment, local);
    			transition_out(katex39.$$.fragment, local);
    			transition_out(katex40.$$.fragment, local);
    			transition_out(katex41.$$.fragment, local);
    			transition_out(katex42.$$.fragment, local);
    			transition_out(katex43.$$.fragment, local);
    			transition_out(katex44.$$.fragment, local);
    			transition_out(badge8.$$.fragment, local);
    			transition_out(katex45.$$.fragment, local);
    			transition_out(katex46.$$.fragment, local);
    			transition_out(box11.$$.fragment, local);
    			transition_out(badge9.$$.fragment, local);
    			transition_out(katex47.$$.fragment, local);
    			transition_out(katex48.$$.fragment, local);
    			transition_out(box12.$$.fragment, local);
    			transition_out(katex49.$$.fragment, local);
    			transition_out(katex50.$$.fragment, local);
    			transition_out(katex51.$$.fragment, local);
    			transition_out(box13.$$.fragment, local);
    			transition_out(katex52.$$.fragment, local);
    			transition_out(box14.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(box10, detaching);
    			...
    			destroy_component(katex27);
    			destroy_component(katex28);
    			destroy_component(katex29);
    			if (detaching) detach_dev(t104);
    			if (detaching) detach_dev(p19);
    			destroy_component(katex30);
    			destroy_component(katex31);
    			destroy_component(katex32);
    			destroy_component(katex33);
    			if (detaching) detach_dev(t110);
    			if (detaching) detach_dev(br2);
    			if (detaching) detach_dev(t111);
    			if (detaching) detach_dev(p20);
    			destroy_component(katex34);
    			destroy_component(katex35);
    			destroy_component(katex36);
    			destroy_component(katex37);
    			if (detaching) detach_dev(t117);
    			if (detaching) detach_dev(p21);
    			destroy_component(katex38);
    			destroy_component(katex39);
    			destroy_component(katex40);
    			if (detaching) detach_dev(t122);
    			if (detaching) detach_dev(p22);
    			destroy_component(katex41);
    			destroy_component(katex42);
    			destroy_component(katex43);
    			destroy_component(katex44);
    			if (detaching) detach_dev(t128);
    			if (detaching) detach_dev(h37);
    			destroy_component(badge8);
    			destroy_component(katex45);
    			if (detaching) detach_dev(t130);
    			if (detaching) detach_dev(p23);
    			destroy_component(katex46);
    			if (detaching) detach_dev(t133);
    			destroy_component(box11, detaching);
    			if (detaching) detach_dev(t134);
    			if (detaching) detach_dev(h38);
    			destroy_component(badge9);
    			destroy_component(katex47);
    			if (detaching) detach_dev(t137);
    			if (detaching) detach_dev(p24);
    			destroy_component(katex48);
    			if (detaching) detach_dev(t140);
    			destroy_component(box12, detaching);
    			if (detaching) detach_dev(t141);
    			if (detaching) detach_dev(p25);
    			destroy_component(katex49);
    			destroy_component(katex50);
    			destroy_component(katex51);
    			if (detaching) detach_dev(t145);
    			destroy_component(box13, detaching);
    			if (detaching) detach_dev(t146);
    			if (detaching) detach_dev(p26);
    			destroy_component(katex52);
    			if (detaching) detach_dev(t149);
    			destroy_component(box14, detaching);
    		}
    	};
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Axiom", slots, []);
    	let header_title = "Geometric Topology";
    	let title = "Axiom of Definition length";
    	let author = "Shigeo Hattori";
    	let hascode = true;
    	let date = "2020, 9, 8";
    	let rss = "Axiom of Definition length.";
    	let tags = ["math"];
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Axiom> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("header_title" in $$props) header_title = $$props.header_title;
    		if ("title" in $$props) title = $$props.title;
    		if ("author" in $$props) author = $$props.author;
    		if ("hascode" in $$props) hascode = $$props.hascode;
    		if ("date" in $$props) date = $$props.date;
    		if ("rss" in $$props) rss = $$props.rss;
    ...
    class Axiom extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\md\dist.tmp\menu1.md generated by Svelte v3.25.1 */
    const file$7 = "src\\md\\dist.tmp\\menu1.md";
    ...
    function create_fragment$8(ctx) {
    	...
    	katex1 = new Katex({ props: { latex: "x^2" }, $$inline: true });

    	const block = {
    		c: function create() {
    			p0 = element("p");
    			p0.textContent = "@def title = \"Code blocks\"\n@def hascode = true\n@def date = Date(2019, 3, 22)\n@def rss = \"A short description of the page which would serve as";
    			t1 = space();
    			p1 = element("p");
    			strong0 = element("strong");
    			strong0.textContent = "blurb";
    			t3 = text(" in a ");
    			code0 = element("code");
    			code0.textContent = "RSS";
    			t5 = text(" feed; you can use basic markdown here but the whole description x string must be a single line (not a multiline string). Like this one for instance. Keep in mind that styling is minimal in RSS so for instance don't expect maths or fancy styling to work; images should be ok though: ");
    			img = element("img");
    			t6 = text("\"");
    			t7 = space();
    			ul0 = element("ul");
    			li0 = element("li");
    			t8 = text("That is, for all ");
    			create_component(katex0.$$.fragment);
    			t9 = text(":");
    			t10 = space();
    			p2 = element("p");
    			p2.textContent = "@def tags = [\"syntax\", \"code\"]";
    			t12 = space();
    			h1 = element("h1");
    			t13 = text("Working with code<=tokyo:6:azabu=>");
    			create_component(katex1.$$.fragment);
    			t14 = text("blocks");
    			t15 = space();
    			p3 = element("p");
    			...
    			t17 = space();
    			h20 = element("h2");
    			h20.textContent = "Live evaluation of code blocks";
    			t19 = space();
    			p4 = element("p");
    			p4.textContent = "De If :x is :(1-x$(1)*3^2) () \nIf you would like to show code as well as what the code outputs, you only need to specify where the script corresponding to the code block will be saved.";
    			t21 = space();
    			p5 = element("p");
    			t22 = text("Indeed, what happens is that the code block gets saved as a script which then gets executed.\nThis also allows for that block to not be re-executed every time you change something ");
    			em0 = element("em");
    			em0.textContent = "else";
    			t24 = text(" on the page.");
    			t25 = space();
    			p6 = element("p");
    			t26 = text("Here's a simple example (change values in ");
    			code1 = element("code");
    			code1.textContent = "a";
    			t28 = text(" to see the results being live updated):");
    			t29 = space();
    			t30 = space();
    			p7 = element("p");
    			p7.textContent = "You can now show what this would look like:";
    			t32 = space();
    			p8 = element("p");
    			strong1 = element("strong");
    			strong1.textContent = "Notes";
    			t34 = text(":");
    			t35 = space();
    			ul1 = element("ul");
    			li1 = element("li");
    			t36 = text("you don't have to specify the ");
    			code2 = element("code");
    			code2.textContent = ".jl";
    			t38 = text(" (see below),");
    			t39 = space();
    			li2 = element("li");
    			t40 = text("you do need to explicitly use print statements or ");
    			code3 = element("code");
    			code3.textContent = "@show";
    			t42 = text(" for things to show, so just leaving a variable at the end like you would in the REPL will show nothing,");
    			t43 = space();
    			li3 = element("li");
    			t44 = text("only Julia code blocks are supported at the moment, there may be a support for scripting languages like ");
    			code4 = element("code");
    			code4.textContent = "R";
    			t46 = text(" or ");
    			code5 = element("code");
    			code5.textContent = "python";
    			t48 = text(" in the future,");
    			t49 = space();
    			li4 = element("li");
    			t50 = text("the way you specify the path is important; see ");
    			a0 = element("a");
    			a0.textContent = "the docs";
    			t52 = text(" for more info. If you don't care about how things are structured in your ");
    			code6 = element("code");
    			code6.textContent = "/assets/";
    			t54 = text(" folder, just use ");
    			code7 = element("code");
    			code7.textContent = "./scriptname.jl";
    			t56 = text(". If you want things to be grouped, use ");
    			code8 = element("code");
    			code8.textContent = "./group/scriptname.jl";
    			t58 = text(". For more involved uses, see the docs.");
    			t59 = space();
    			p9 = element("p");
    			t60 = text("Lastly, it's important to realise that if you don't change the content of the code, then that code will only be executed ");
    			em1 = element("em");
    			em1.textContent = "once";
    			t62 = text(" even if you make multiple changes to the text around it.");
    			t63 = space();
    			p10 = element("p");
    			p10.textContent = "Here's another example,";
    			t65 = space();
    			t66 = space();
    			p11 = element("p");
    			p11.textContent = "which gives the (utterly useless):";
    			t68 = space();
    			p12 = element("p");
    			t69 = text("note the absence of ");
    			code9 = element("code");
    			code9.textContent = ".jl";
    			t71 = text(", it's inferred.");
    			t72 = space();
    			p13 = element("p");
    			p13.textContent = "You can also hide lines (that will be executed nonetheless):";
    			t74 = space();
    			t75 = space();
    			h21 = element("h2");
    			h21.textContent = "Including scripts";
    			t77 = space();
    			p14 = element("p");
    			t78 = text("Another approach is to include the content of a script that has already been executed.\nThis can be an alternative to the description above if you'd like to only run the code once because it's particularly slow or because it's not Julia code.\nFor this you can use the ");
    			code10 = element("code");
    			code10.textContent = "\\input";
    			t80 = text(" command specifying which language it should be tagged as:");
    			t81 = space();
    			p15 = element("p");
    			t82 = text("these scripts can be run in such a way that their output is also saved to file, see ");
    			code11 = element("code");
    			code11.textContent = "scripts/generate_results.jl";
    			t84 = text(" for instance, and you can then also input the results:");
    			t85 = space();
    			p16 = element("p");
    			p16.textContent = "which is convenient if you're presenting code.";
    			t87 = space();
    			p17 = element("p");
    			strong2 = element("strong");
    			strong2.textContent = "Note";
    			t89 = text(": paths specification matters, see ");
    			a1 = element("a");
    			a1.textContent = "the docs";
    			t91 = text(" for details.");
    			t92 = space();
    			p18 = element("p");
    			t93 = text("Using this approach with the ");
    			code12 = element("code");
    			code12.textContent = "generate_results.jl";
    			t95 = text(" file also makes sure that all the code on your website works and that all results match the code which makes maintenance easier.");
    			add_location(p0, file$7, 0, 0, 0);
    			add_location(strong0, file$7, 4, 3, 168);
    			add_location(code0, file$7, 4, 31, 196);
    			if (img.src !== (img_src_value = "https://upload.wikimedia.org/wikipedia/en/3/32/Rick_and_Morty_opening_credits.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$7, 4, 334, 499);
    			add_location(p1, file$7, 4, 0, 165);
    			add_location(li0, file$7, 6, 0, 616);
    			add_location(ul0, file$7, 5, 0, 611);
    			add_location(p2, file$7, 8, 0, 706);
    			add_location(h1, file$7, 9, 0, 764);
    			add_location(p3, file$7, 10, 0, 844);
    			add_location(h20, file$7, 11, 0, 856);
    			add_location(p4, file$7, 12, 0, 896);
    			add_location(em0, file$7, 15, 86, 1270);
    			add_location(p5, file$7, 14, 0, 1088);
    			add_location(code1, file$7, 16, 49, 1350);
    			add_location(p6, file$7, 16, 0, 1301);
    			html_tag = new HtmlTag(t30);
    			add_location(p7, file$7, 18, 0, 1429);
    			add_location(strong1, file$7, 19, 3, 1483);
    			add_location(p8, file$7, 19, 0, 1480);
    			add_location(code2, file$7, 21, 38, 1554);
    			add_location(li1, file$7, 21, 0, 1516);
    			add_location(code3, file$7, 22, 54, 1643);
    			add_location(li2, file$7, 22, 0, 1589);
    			add_location(code4, file$7, 23, 108, 1879);
    			add_location(code5, file$7, 23, 126, 1897);
    			add_location(li3, file$7, 23, 0, 1771);
    			attr_dev(a0, "href", "https://tlienart.github.io/franklindocs/code/index.html#more_on_paths");
    			add_location(a0, file$7, 24, 51, 1988);
    			add_location(code6, file$7, 24, 221, 2158);
    			add_location(code7, file$7, 24, 260, 2197);
    			add_location(code8, file$7, 24, 328, 2265);
    			add_location(li4, file$7, 24, 0, 1937);
    			add_location(ul1, file$7, 20, 0, 1511);
    			add_location(em1, file$7, 26, 132, 2482);
    			add_location(p9, file$7, 26, 0, 2350);
    			add_location(p10, file$7, 27, 0, 2557);
    			html_tag_1 = new HtmlTag(t66);
    			add_location(p11, file$7, 29, 0, 2612);
    			add_location(code9, file$7, 30, 23, 2677);
    			add_location(p12, file$7, 30, 0, 2654);
    			add_location(p13, file$7, 31, 0, 2718);
    			html_tag_2 = new HtmlTag(t75);
    			add_location(h21, file$7, 33, 0, 2806);
    			add_location(code10, file$7, 36, 25, 3115);
    			add_location(p14, file$7, 34, 0, 2833);
    			add_location(code11, file$7, 37, 87, 3284);
    			add_location(p15, file$7, 37, 0, 3197);
    			add_location(p16, file$7, 38, 0, 3384);
    			add_location(strong2, file$7, 39, 3, 3445);
    			attr_dev(a1, "href", "https://tlienart.github.io/franklindocs/code/index.html#more_on_paths");
    			add_location(a1, file$7, 39, 59, 3501);
    			add_location(p17, file$7, 39, 0, 3442);
    			add_location(code12, file$7, 40, 32, 3643);
    			add_location(p18, file$7, 40, 0, 3611);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(h1, t13);
    			mount_component(katex1, h1, null);
    			append_dev(h1, t14);
    ...
    const CODEBLOCK_1 = `<pre><code class="language-julia:./exdot.jl">using LinearAlgebra
a = [1, 2, 3, 3, 4, 5, 2, 2]
@show dot(a, a)
println(dot(a, a))</code></pre>
`;

    const CODEBLOCK_2 = `<pre><code class="language-julia:./code/ex2">for i ∈ 1:5, j ∈ 1:5
    print(&quot; &quot;, rpad(&quot;*&quot;^i,5), lpad(&quot;*&quot;^(6-i),5), j==5 ? &quot;\n&quot; : &quot; &quot;^4)
end</code></pre>
`;

    const CODEBLOCK_3 = `<pre><code class="language-julia:./code/ex3">using Random
Random.seed!(1) # hide
...
`;
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Menu1", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Menu1> was created with unknown prop '${key}'`);
    	});
    ...
    class Menu1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\Router.tmp.svelte generated by Svelte v3.25.1 */
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Router_tmp", slots, []);
    	let { page: page$1 } = $$props, { wndw } = $$props;
    	page("/", () => $$invalidate(0, page$1 = Home));
    	page("/about", () => $$invalidate(0, page$1 = About));
    	page("/axiom_md", () => $$invalidate(0, page$1 = Axiom));
    	page("/menu1_md", () => $$invalidate(0, page$1 = Menu1));

    	/*end generated*/
    	page("/x.a.b.c", () => $$invalidate(0, page$1 = About));

    	page("*", () => $$invalidate(0, page$1 = NotFound));
    	page.start();
    	const writable_props = ["page", "wndw"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Router_tmp> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ("page" in $$props) $$invalidate(0, page$1 = $$props.page);
    		if ("wndw" in $$props) $$invalidate(1, wndw = $$props.wndw);
    	};
    ...
    class Router_tmp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { page: 0, wndw: 1 });
    		...
    		if (/*page*/ ctx[0] === undefined && !("page" in props)) {
    			console.warn("<Router_tmp> was created without expected prop 'page'");
    		}

    		if (/*wndw*/ ctx[1] === undefined && !("wndw" in props)) {
    			console.warn("<Router_tmp> was created without expected prop 'wndw'");
    		}
    	}

    	get page() {
    		throw new Error("<Router_tmp>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set page(value) {
    		throw new Error("<Router_tmp>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\components\Toc.File.svelte generated by Svelte v3.25.1 */

    const file$8 = "src\\components\\Toc.File.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$8, 14, 6, 245);
    			attr_dev(span, "class", "svelte-1cc2u1h");
    			add_location(span, file$8, 14, 0, 239);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Toc_File", slots, []);
    	let { name } = $$props;
    	let { route } = $$props;
    	const writable_props = ["name", "route"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Toc_File> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ name, route, type });
    ...
    class Toc_File extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { name: 0, route: 1 });
    		...
    		if (/*name*/ ctx[0] === undefined && !("name" in props)) {
    			console.warn("<Toc_File> was created without expected prop 'name'");
    		}

    		if (/*route*/ ctx[1] === undefined && !("route" in props)) {
    			console.warn("<Toc_File> was created without expected prop 'route'");
    		}
    	}

    	get name() {
    		throw new Error("<Toc_File>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<Toc_File>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\components\Toc.Folder.svelte generated by Svelte v3.25.1 */
    const file$9 = "src\\components\\Toc.Folder.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-rtlgqd");
    			add_location(ul, file$9, 49, 1, 1111);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    ...
    function create_else_block(ctx) {
    	let file_1;
    	let current;
    	const file_1_spread_levels = [/*file*/ ctx[5], { href: /*file*/ ctx[5].href }];
    	let file_1_props = {};
    	...
    	file_1 = new Toc_File({ props: file_1_props, $$inline: true });
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(file_1_spread_levels, [get_spread_object(/*file*/ ctx[5]), { href: /*file*/ ctx[5].href }])
    			: {};
    ...
    // (53:4) {#if file.type === 'folder'}
    function create_if_block_1(ctx) {
    	let toc_folder;
    	let current;
    	const toc_folder_spread_levels = [/*file*/ ctx[5]];
    	let toc_folder_props = {};

    	for (let i = 0; i < toc_folder_spread_levels.length; i += 1) {
    		toc_folder_props = assign(toc_folder_props, toc_folder_spread_levels[i]);
    	}

    	toc_folder = new Toc_Folder({ props: toc_folder_props, $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(toc_folder.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(toc_folder, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const toc_folder_changes = (dirty & /*files*/ 4)
    			? get_spread_update(toc_folder_spread_levels, [get_spread_object(/*file*/ ctx[5])])
    			: {};

    			toc_folder.$set(toc_folder_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(toc_folder.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(toc_folder.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(toc_folder, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(53:4) {#if file.type === 'folder'}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*file*/ ctx[5].type === "folder") return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			t = space();
    			attr_dev(li, "class", "svelte-rtlgqd");
    			add_location(li, file$9, 51, 3, 1145);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:2) {#each files as file}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-rtlgqd");
    			toggle_class(span, "expanded", /*expanded*/ ctx[0]);
    			add_location(span, file$9, 42, 0, 696);
    			attr_dev(path0, "d", "M 0 0 L 0 6.4 L 6.4 6.4 ");
    			add_location(path0, file$9, 43, 5, 943);
    			add_location(g0, file$9, 43, 0, 938);
    			attr_dev(path1, "d", "M 0 0  L 3.2 3.2 L 0 3.2 Z ");
    			add_location(path1, file$9, 44, 32, 1019);
    			attr_dev(g1, "stroke", "black");
    			attr_dev(g1, "fill", "black");
    			add_location(g1, file$9, 44, 0, 987);
    			set_style(svg, "cursor", "pointer");
    			set_style(svg, "display", "inline-block");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 6.4 6.4");
    			attr_dev(svg, "width", "0.7em");
    			attr_dev(svg, "height", "0.7em");
    			attr_dev(svg, "stroke", "black");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$9, 42, 58, 754);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span, "click", /*toggle*/ ctx[3], false, false, false),
    					listen_dev(svg, "click", goUp, false, false, false)
    				];
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Toc_Folder", slots, []);
    	...
    	const writable_props = ["expanded", "name", "files", "href"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Toc_Folder> was created with unknown prop '${key}'`);
    	});
    	...
    	return [expanded, name, files, toggle, href];
    }

    class Toc_Folder extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { expanded: 0, name: 1, files: 2, href: 4 });
    		...
    		if (/*name*/ ctx[1] === undefined && !("name" in props)) {
    			console.warn("<Toc_Folder> was created without expected prop 'name'");
    		}

    		if (/*files*/ ctx[2] === undefined && !("files" in props)) {
    			console.warn("<Toc_Folder> was created without expected prop 'files'");
    		}

    		if (/*href*/ ctx[4] === undefined && !("href" in props)) {
    			console.warn("<Toc_Folder> was created without expected prop 'href'");
    		}
    	}

    	get expanded() {
    		throw new Error("<Toc_Folder>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set expanded(value) {
    		throw new Error("<Toc_Folder>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    let Toc=
    [{type:"folder",indices:[1],route:"",name:"",files:[{type:"file",indices:[1],route:"/axiom_md",name:"axiom.md"},{type:"file",indices:[1],route:"/menu1_md",name:"menu1.md"}]}];

    /* src\components\Toc.svelte generated by Svelte v3.25.1 */

    function create_fragment$c(ctx) {
    	let folder;
    	let current;

    	folder = new Toc_Folder({
    			props: {
    				name: "Home",
    				files: /*Toc2*/ ctx[0],
    				expanded: true
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Folder: Toc_Folder, Toc, Toc2 });

    	$$self.$inject_state = $$props => {
    		if ("Toc2" in $$props) $$invalidate(0, Toc2 = $$props.Toc2);
    	};
    ...
    class Toc_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\Page.svelte generated by Svelte v3.25.1 */
    ...
    class Page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { page: 0 });
    		...
    		if (/*page*/ ctx[0] === undefined && !("page" in props)) {
    			console.warn("<Page> was created without expected prop 'page'");
    		}
    	}
    ...
    const title = writable("Math vs. IT");
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			br = element("br");
    			attr_dev(h1, "class", "svelte-g90gct");
    			add_location(h1, file$a, 53, 2, 1035);
    			attr_dev(div0, "class", "text-center");
    			add_location(div0, file$a, 52, 1, 1006);
    			attr_dev(div1, "class", "grid grid-cols-8 gap-0 justify-center ");
    			add_location(div1, file$a, 57, 0, 1071);
    			add_location(br, file$a, 76, 0, 1534);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*year, thc*/ 12) {
    				each_value_1 = /*thc*/ ctx[2];
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-g90gct");
    			add_location(h1, file$a, 26, 0, 547);
    			attr_dev(div, "class", "grid grid-cols-8 gap-0 justify-center ");
    			add_location(div, file$a, 27, 0, 582);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			html_tag.m(/*span10*/ ctx[4], h1);
    			append_dev(h1, t0);
    			insert_dev(target, t1, anchor);
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*title_v*/ 2) set_data_dev(t0, /*title_v*/ ctx[1]);

    			if (dirty & /*thc*/ 4) {
    				each_value = /*thc*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_else_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			use = svg_element("use");
    			t = space();
    			attr_dev(use, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			xlink_attr(use, "xlink:href", use_xlink_href_value = "images/HC.svg#" + /*symbol*/ ctx[6]);
    			attr_dev(use, "transform", "scale(7 7) translate(0 0) ");
    			add_location(use, file$a, 67, 1, 1348);
    			attr_dev(svg, "role", "img");
    			attr_dev(svg, "class", "svelte-g90gct");
    			add_location(svg, file$a, 66, 0, 1328);
    			attr_dev(div, "class", "col-span-3 text-center ");
    			add_location(div, file$a, 65, 0, 1287);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span = element("span");
    			span.textContent = `Math vs. IT ${/*year*/ ctx[3]}`;
    			add_location(span, file$a, 62, 63, 1235);
    			attr_dev(div, "class", "col-span-2 text-center ");
    			set_style(div, "margin-top", "0.5em");
    			add_location(div, file$a, 62, 0, 1172);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    // (60:0) {#each  thc as symbol}
    function create_each_block_1(ctx) {
    	let if_block_anchor;

    	function select_block_type_2(ctx, dirty) {
    		if (/*symbol*/ ctx[6] == "") return create_if_block_2;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(60:0) {#each  thc as symbol}",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			xlink_attr(use, "xlink:href", use_xlink_href_value = "images/HC.svg#" + /*symbol*/ ctx[6]);
    			attr_dev(use, "transform", "scale(7 7) translate(0 0) ");
    			add_location(use, file$a, 37, 1, 800);
    			attr_dev(svg, "role", "img");
    			attr_dev(svg, "class", "svelte-g90gct");
    			add_location(svg, file$a, 36, 0, 780);
    			attr_dev(div, "class", "col-span-3 text-center");
    			add_location(div, file$a, 35, 0, 740);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "col-span-2 text-center ");
    			add_location(div, file$a, 32, 0, 683);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    // (30:0) {#each  thc as symbol}
    function create_each_block$1(ctx) {
    	let if_block_anchor;

    	function select_block_type_1(ctx, dirty) {
    		if (/*symbol*/ ctx[6] == "") return create_if_block_1$1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:0) {#each  thc as symbol}",
    		ctx
    	});
    ...
    function create_fragment$e(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*asHeader*/ ctx[0]) return create_if_block$1;
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	let { asHeader = true } = $$props;
    	let title_v;

    	const unsubscribe = title.subscribe(value => {
    		$$invalidate(1, title_v = value);
    	});

    	let thc = asHeader ? ["tl", "", "tr"] : ["bl", "", "br"];
    	let year = new Date().getFullYear();
    	const span10 = ("<span>&#x0200A;</span>").repeat(12);
    	const writable_props = ["asHeader"];
    	...
    	$$self.$$set = $$props => {
    		if ("asHeader" in $$props) $$invalidate(0, asHeader = $$props.asHeader);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("asHeader" in $$props) $$invalidate(0, asHeader = $$props.asHeader);
    		if ("title_v" in $$props) $$invalidate(1, title_v = $$props.title_v);
    		if ("thc" in $$props) $$invalidate(2, thc = $$props.thc);
    	...
    	return [asHeader, title_v, thc, year, span10];
    }

    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { asHeader: 0 });
    ...
    function create_fragment$f(ctx) {
    	...
    	function router_page_binding(value) {
    		/*router_page_binding*/ ctx[6].call(null, value);
    	}

    	let router_props = { wndw: /*wndw*/ ctx[0] };

    	if (/*page*/ ctx[1] !== void 0) {
    		router_props.page = /*page*/ ctx[1];
    	}

    	router = new Router_tmp({ props: router_props, $$inline: true });
    	binding_callbacks.push(() => bind(router, "page", router_page_binding));
    	header0 = new Header({ $$inline: true });
    	menu = new Toc_1({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/x.a.b.c");
    			add_location(a, file$b, 34, 6, 908);
    			add_location(span, file$b, 34, 0, 902);
    			set_style(div0, "visibility", /*MenuV*/ ctx[4]);
    			attr_dev(div0, "class", div0_class_value = "col-span-" + /*colL*/ ctx[3]);
    			add_location(div0, file$b, 38, 2, 996);
    			attr_dev(div1, "class", div1_class_value = "col-span-" + /*colC*/ ctx[2]);
    			add_location(div1, file$b, 39, 2, 1070);
    			attr_dev(div2, "class", "col-span-1");
    			add_location(div2, file$b, 40, 2, 1142);
    			attr_dev(div3, "class", "grid grid-cols-8 gap-4");
    			add_location(div3, file$b, 37, 0, 957);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(page_1, div1, null);
    			append_dev(div3, t5);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*wndw*/ 1) router_changes.wndw = /*wndw*/ ctx[0];

    			if (!updating_page && dirty & /*page*/ 2) {
    				updating_page = true;
    				router_changes.page = /*page*/ ctx[1];
    				add_flush_callback(() => updating_page = false);
    			}

    			router.$set(router_changes);

    			if (!current || dirty & /*MenuV*/ 16) {
    				set_style(div0, "visibility", /*MenuV*/ ctx[4]);
    			}

    			if (!current || dirty & /*colL*/ 8 && div0_class_value !== (div0_class_value = "col-span-" + /*colL*/ ctx[3])) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			const page_1_changes = {};
    			if (dirty & /*page*/ 2) page_1_changes.page = /*page*/ ctx[1];
    			...
    			if (!current || dirty & /*colC*/ 4 && div1_class_value !== (div1_class_value = "col-span-" + /*colC*/ ctx[2])) {
    ...
    function instance$f($$self, $$props, $$invalidate) {
    	...
    	function readUrlQuery() {
    		var queryString = wndw.location.search;
    		...
    		if (queryObject["wide"] != null) {
    			$$invalidate(2, colC = 6);
    			$$invalidate(3, colL = 1);
    			$$invalidate(4, MenuV = "hidden");
    		}
    	}

    	readUrlQuery();
    	const writable_props = ["wndw", "dcmnt"];
    	...
    	$$self.$$set = $$props => {
    		if ("wndw" in $$props) $$invalidate(0, wndw = $$props.wndw);
    		if ("dcmnt" in $$props) $$invalidate(5, dcmnt = $$props.dcmnt);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("colC" in $$props) $$invalidate(2, colC = $$props.colC);
    		if ("colL" in $$props) $$invalidate(3, colL = $$props.colL);
    		if ("MenuV" in $$props) $$invalidate(4, MenuV = $$props.MenuV);
    	};
    	...
    	return [wndw, page, colC, colL, MenuV, dcmnt, router_page_binding];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { wndw: 0, dcmnt: 5 });
    		...
    		if (/*wndw*/ ctx[0] === undefined && !("wndw" in props)) {
    			console.warn("<App> was created without expected prop 'wndw'");
    		}

    		if (/*dcmnt*/ ctx[5] === undefined && !("dcmnt" in props)) {
    			console.warn("<App> was created without expected prop 'dcmnt'");
    		}
    	}
    ...
    console.log("main.js");
    const app = new App({
    	target: document.getElementById("idSvelte"),
    	props: {
        wndw: window,
        dcmnt: document
    	}
    ...
    /*
    install svelte: https://github.com/sveltejs/svelte
    markdown: https://alexxnb.github.io/svelte-preprocess-markdown/
    router: https://blog.jscrambler.com/svelte-routing-with-page-js/

    tailwind: https://dev.to/inalbant/a-simpler-way-to-add-tailwindcss-to-your-svelte-project-11ja
    */
